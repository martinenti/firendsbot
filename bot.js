...
client.on('message', message => { //By |.iiMostafaYT#1001
    ...
    message.channel.send({ //By |.iiMostafaYT#1001
        embed: new Discord.RichEmbed() //By |.iiMostafaYT#1001
            ...
            .setTitle('Info FriendsBot.') //By |.iiMostafaYT#1001
            ...
            message.channel.sendEmbed(embedx);
                                 ...
                                 client.on('message' , message => {
                                    ...
                                    client.on('message', message => { 
                                        ...
                                        .setFooter(`FriendsBot.`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
...
Servers Counter : __${client.guilds.size}__**`)
         .setColor("#f3ae10")
         .addField("New Server!")
         .setFooter('FriendsBot Premium' , client.user.avatarURL)
...
client.on('guildDelete', guild => {
  client.channels.get("513020768859455488")
const embed = new Discord.RichEmbed()
   .setAuthor(`FriendsBot Premium left a server ❎`)
   .setDescription(`**
Server name: __${guild.name}__
Server id: __${guild.id}__
Server owner: __${guild.owner}__
